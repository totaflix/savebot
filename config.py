...
BOT_TOKEN = os.getenv("BOT_TOKEN", "8379097786:AAEdIFsQebcWbmLURBBRSA7mfrQy1OLmF4o")
...
LOG_GROUP = int(os.getenv("LOG_GROUP", "-1002686552103")) # optional with -100
FORCE_SUB = int(os.getenv("FORCE_SUB", "-1003016822274")) # optional with -100
